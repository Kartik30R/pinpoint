...
class _BuildingService implements BuildingService {
  ...
  Future<List<BuildingDto>> getBuildingsByInstitute(
    ...
    final _options = _setStreamType<List<BuildingDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          '/buildings/institute/${instituteId}',
  ...
  Future<BuildingDto> getBuildingById(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BuildingDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<FloorDto>> getFloorsByBuilding(String buildingId) async {
    ...
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<FloorDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
