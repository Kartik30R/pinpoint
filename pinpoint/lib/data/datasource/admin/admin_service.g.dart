...
class _AdminService implements AdminService {
  ...
  @override
  Future<HttpResponse<MessageResponse>> createAdmin(AuthRequest request) async {
  ...
  @override
  Future<HttpResponse<AdminResponse>> getAdminById(String adminId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<MessageResponse>> deleteAdmin(String adminId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
